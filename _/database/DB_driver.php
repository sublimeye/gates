...
class CI_DB_driver {
	...
	function CI_DB_driver($params)
	{
		...
		$this->log_path = BASEPATH.'application/logs/';
	...
	function log_file($var,$msg = "",$file_name = "",$mode = NULL)
    {
		$file_name = (!empty($file_name)) ? $file_name : $this->log_file;
		$log_state = $this->db_debug; 
		
		if($log_state && is_string($file_name) && !empty($file_name))
        {
            $s = "";
