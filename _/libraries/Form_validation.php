...
class CI_Form_validation {
	...
	{
		return (bool) (is_array($var) && count($var)) ? TRUE : FALSE;
	}
	...
	{
		return preg_match("/^(0[1-9]|[12][0-9]|3[01])[-\.](0[1-9]|1[012])[-\.](19|20)\d\d$/",$var);
	}
	 ...
	 * @return	bool
	 */
	function valid_time($var)
	{
		return preg_match("/^([0-1][0-9]|[2][0-3]):([0-5][0-9])$/",$var);
	}
	 ...
	 * @return	bool
	 */
	function capcha_check($var)
	{
		include(getenv('DOCUMENT_ROOT')."/lib/securimage.php"); 
		
		$capcha = new Securimage();
        $capcha_var = $capcha->check($var);

		return (bool)$capcha_var;
	}
